...
/// [InfoWindow] 的点击事件
class InfoWindowTapEvent extends MapEvent<String> {
  InfoWindowTapEvent(int mapId, String markerId) : super(mapId, markerId);
}
...
class MapPoiSearchDoneEvent extends MapEvent<dynamic> {
  MapPoiSearchDoneEvent(int mapId, dynamic pois) : super(mapId, pois);
}