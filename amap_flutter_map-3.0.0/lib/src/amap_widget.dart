...
class AMapWidget extends StatefulWidget {
  ...
  final ArgumentCallback<dynamic>? onPoiSearchDone;
  ///位置回调
...
class _MapState extends State<AMapWidget> {
  ...
  void onInfoWindowTap(String markerId) {
    final Marker? _marker = _markers[markerId];
    if (_marker != null) {
      final ArgumentCallback<String>? _onInfoWinowTap = _marker.infoWindow.onInfoWinowTap;
      if (_onInfoWinowTap != null) {
        _onInfoWinowTap(markerId);
      }
    }
  }
